...
\begin{itemize}
  \item[] Chapter 1A: $\mathbf{R}^n$ and $\mathbf{C}^n$
  \item[] Chapter 1B: Definition of Vector Space
  \item[] Chapter 1C: Subspaces
\end{itemize}
:::
...
\begin{itemize}
  \item[] Chapter 2A: Span and Linear Independence
  \item[] Chapter 2B: Bases
  \item[] Chapter 2C: Dimension
\end{itemize}
:::
...
\begin{itemize}
  \item[] Chapter 3A: Vector Space of Linear Maps
  \item[] Chapter 3B: Null Spaces and Ranges
  \item[] Chapter 3C: Matrices
  \item[] Chapter 3D: Invertibility and Isomorphisms
  \item[] Chapter 3E: Products and Quotients of Vector Spaces
\end{itemize}
:::
...
\begin{itemize}
  \item[] Chapter 5A: Invariant Subspaces
  \item[] Chapter 5B: The Minimal Polynomial
  \item[] Chapter 5C: Upper-Triangular Matrices
  \item[] Chapter 5D: Diagonalizable Operators
\end{itemize}
:::
...
\begin{itemize}
  \item[] Chapter 6A: Inner Products and Norms
  \item[] Chapter 6B: Orthonormal Bases
  \item[] Chapter 6C: Orthogonal Complements and Minimization Problems
\end{itemize}
:::
...
\begin{itemize}
  \item[] Chapter 7A: Self-Adjoint and Normal Operators
  \item[] Chapter 7B: Spectral Theorem
  \item[] Chapter 7C: Positive Operators
  \item[] Chapter 7D: Isometries, Unitary Operators, and Matrix Factorization
  \item[] Chapter 7E: Singular Value Decomposition
  \item[] Chapter 7F: Consequences of Singular Value Decomposition
\end{itemize}
:::