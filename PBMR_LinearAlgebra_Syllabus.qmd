...
# Motivation 
  ...
  - This fourth session of the reading group is on *Linear Algebra*.

# Prerequisites

  - CGPA: 3.00/4.00 and \href{https://www.youtube.com/playlist?list=PLE7DDD91010BC51F8}{\faYoutube Linear Algebra - Gilbert Strang (2005)}
  - Please apply by uploading your CV and transcript to this [\faLink Google Form](https://docs.google.com/forms/d/e/1FAIpQLSf2cwRPXWqVCckj8O1YOTDVseADO7s1afsAbc9tePf-kQnHQQ/viewform) until 23:59, 10 March 2024.  
    Please upload your CV and transcript as **NameSurname.pdf**, not **CV.pdf**.  
    Students who applied will be informed about their application results via email at 10:00, 12 March 2024.
...
\begin{itemize}
  ...
  \item[\faBook] \href{https://math.solverer.com/library/sheldon_axler/linear_algebra_done_right?utm_source=reddit&utm_medium=link}{Linear Algebra Done Right - Sheldon Axler (3rd Edition, 2015, Solutions by math.solverer.com)}
\end{itemize}
...
\begin{itemize}
  ...
  \item[\faBook] \href{https://media.pearsoncmg.com/cmg/pmmg_mml_shared/Chartrand_4e/Chartrand4e_Ch17.pdf}{Mathematical Proofs A Transition to Advanced Mathematics - Gary Chartrand, Albert D. Polimeni, Ping Zhang (Chapter 17 Proof in Linear Algebra, 4th Edition, 2018)} and \href{https://media.pearsoncmg.com/cmg/pmmg_mml_shared/Chartrand_4e/Chartrand4e_Ch16-19_odd_answers.pdf#page=2}{Odd-Numbered Exercise Solutions}
\end{itemize}
