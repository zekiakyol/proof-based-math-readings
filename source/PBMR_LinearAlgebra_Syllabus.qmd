...
- CGPA: 3.00/4.00.
- Proof resources below and [\faYoutube Linear Algebra - Gilbert Strang (2005)](https://www.youtube.com/playlist?list=PLE7DDD91010BC51F8) are the prerequisites for this session.
...
**Linear Algebra Done Right (4th Edition, 2024)** by Sheldon Axler is our main book for this session because it is well-written, well-structured, and open-access.  

Robert Won's playlist is our main playlist because his narrative is just great.

\begin{itemize}
  \item[\faBook] \href{https://linear.axler.net/LADR4e.pdf}{Linear Algebra Done Right - Sheldon Axler (4th Edition, 2024, Errata-free version)}
  \item[\faYoutube] \href{https://www.youtube.com/playlist?list=PLoxJTbDttvt7ny0WEJHWw6-0Sjx7EImIQ}{Linear Algebra Done Right - Sheldon Axler (4th Edition, 2024, Playlist by Robert Won)}
  \item[\faYoutube] \href{https://linear.axler.net/LADRvideos4e.html}{Linear Algebra Done Right - Sheldon Axler (4th Edition, 2024, Playlist by Sheldon Axler)}
  \item[\faYoutube] \href{https://www.youtube.com/playlist?list=PLUOF6EOFxCQ2BY71kLBGleN0c9aKke3Vd}{Linear Algebra Done Right - Sheldon Axler (4th Edition, 2024, Solutions by MathwithoutCommentary)}
...
\begin{itemize}
  ...
  \item[\faYoutube] \href{https://mediaspace.illinois.edu/channel/MATH%2B416%2BAbstract%2BLinear%2BAlgebra/223194603}{Linear Algebra Done Right - Sheldon Axler (3rd Edition, 2015, Playlist by Felix Leditzky)}
\end{itemize}
...
\begin{itemize}
  ...
  \item[\faYoutube] \href{https://www.youtube.com/@jeremy9959/playlists?view=50&sort=dd&shelf_id=5}{Book of Proof - Richard Hammack (3.3 Edition, 2022, Playlist by Jeremy Teitelbaum, Chapter 1-12)}
  \item[\faYoutube] \href{https://www.youtube.com/playlist?list=PLVMgvCDIRy1x00m7Oo9XzEkDDACeEK_m-}{Book of Proof - Richard Hammack (3.3 Edition, 2022, Playlist by Michael Penn, Chapter 1-14)}
\end{itemize}
...
You can check out our Matrix Algebra syllabus at [\faGithub github.com/zekiakyol/proof-based-math-readings](https://github.com/zekiakyol/proof-based-math-readings)
