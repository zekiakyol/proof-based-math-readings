...
- CGPA: 3.00/4.00. Supplementary Python and one of the Algorithms resources below.
...
\begin{itemize}
  \item[\faBook] Grokking Algorithms - Aditya Bhargava (2nd Edition, 2024) $\qquad \rightarrow$ Easier to read
  ...
  \item[\faYoutube] \href{https://www.youtube.com/@gjenkinsedu/playlists}{Problem Solving with Algorithms and Data Structures using Python - B. Miller, D. Ranum, R. Yasinovskyy (3rd Edition, 2023, Playlist by Gerry Jenkins)}
\end{itemize}
