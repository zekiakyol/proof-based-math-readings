...
**Basic Analysis I: Introduction to Real Analysis - Jiri Lebl (Version 6.0, 2023)** is our main book for this session because it is well-written, well-structured, and open-access.  
