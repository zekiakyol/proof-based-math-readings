...
**Basic Analysis I: Introduction to Real Analysis** by Jiri Lebl is our main book for this session because it is well-written, well-structured, and open-access.  
...
\begin{itemize}
  ...
  \item[\faBook] \href{https://ocw.mit.edu/courses/18-100a-real-analysis-fall-2020/resources/mit18_100af20_lec_full2/}{Basic Analysis I: Introduction to Real Analysis - Jiri Lebl (Version 6.0, 2023, Notes by Casey Rodriguez)}
\end{itemize}
...
\begin{itemize}
  \item[\faYoutube] \href{https://www.youtube.com/playlist?list=PLztBpqftvzxWo4HxUYV58ENhxHV32Wxli}{Real Analysis - Wrath of Math (2024)} $\quad \rightarrow$ Start with this playlist if you find the main book challenging
...
- **BAI** is Basic Analysis I: Introduction to Real Analysis - Jiri Lebl (Version 6.0, 2023).
...
You can check out our Topology syllabus at [\faGithub github.com/zekiakyol/proof-based-math-readings](https://github.com/zekiakyol/proof-based-math-readings)
