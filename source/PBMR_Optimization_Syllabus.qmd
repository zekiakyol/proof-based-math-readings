...
::: {.callout-tip icon=false}
## **\faBook AFCOT \hfill Week 07-08 \faCalendar* **
...
::: {.callout-tip icon=false}
## **\faBook AFCOT \hfill Week 09-10 \faCalendar* **
...
::: {.callout-tip icon=false}
## **\faBook AFCOT \hfill Week 11-12 \faCalendar* **

\begin{itemize}
  \item[] Chapter 11: Finite-Horizon Dynamic Programming
  \item[] Chapter 12: Stationary Discounted Dynamic Programming
\end{itemize}
:::