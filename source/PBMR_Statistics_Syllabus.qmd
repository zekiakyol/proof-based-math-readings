...
**Statistical Inference (2nd Edition, 2001)** by George Casella and Roger Berger is our main book because it is well-written and well-structured.
...
\begin{itemize}
  ...
  \item[\faYoutube] \href{https://www.youtube.com/playlist?list=PL5LSj-W8URK2VkbA8HCeoyMLr2783GSZN}{Statistical Inference - George Casella, Roger Berger (2nd Edition, 2001, Playlist for Chapter 1-5)}
...
\begin{itemize}
  \item[] \textbf{1.1} Set Theory, \textbf{1.2} Basics of Probability Theory, \textbf{1.3} Conditional Probability and Independence,
