...
\begin{itemize}
  ...
  \item[\faBook] \href{https://stat110.hsites.harvard.edu/strategic-practice-problems}{Introduction to Probability - Joseph K. Blitzstein, Jessiza Hwang (2nd Edition, 2019, Selected Solutions)}
...
\begin{itemize}\setlength\itemsep{-0.22cm}
  \item[] \textbf{1.1} Set Theory
  \item[] \textbf{1.2} Probability Theory
  \item[] \textbf{1.3} Conditional Probability and Independence
  \item[] \textbf{1.4} Random Variables
  \item[] \textbf{1.5} Distribution Functions
  \item[] \textbf{1.6} Density and Mass Functions
\end{itemize}
:::
