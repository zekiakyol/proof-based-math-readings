...
1) Read the chapter and watch the matching playlist.
...
4) If stuck, ask questions in Discord.
...
\begin{itemize}
  \item[\faBook] Mathematical Proofs - G. Chartrand, A. Polimeni, P. Zhang (\textbf{Chapter 0-14}, 4th Edition, 2018) \href{https://media.pearsoncmg.com/cmg/pmmg_mml_shared/Chartrand_4e}{\faDesktop}
\end{itemize}
:::
