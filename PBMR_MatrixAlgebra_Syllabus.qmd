...
# Format
  ...
  - This session will last 10 weeks from 23 October 2023 to 07 January 2024.
...
::: {.callout-tip icon=false}
## **Week 07-08 \hfill \faCalendar* 04 December - 24 December**
...
::: {.callout-tip icon=false}
## **Week 09-10 \hfill \faCalendar* 25 December - 07 January**
...
\begin{itemize}
  ...
  \item[] We will also have a session on Linear Algebra Done Right. Please see our syllabus at \href{https://github.com/zekiakyol/proof-based-math-readings/blob/main/PBMR_LinearAlgebra_Syllabus.pdf}{Linear Algebra}
\end{itemize}
:::
