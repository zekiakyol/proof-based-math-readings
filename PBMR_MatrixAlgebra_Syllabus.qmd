...
\begin{itemize}
  ...
  \item[] We will also have a session on this book. Please see our syllabus at \href{https://github.com/zekiakyol/proof-based-math-readings/blob/main/PBMR_LinearAlgebra_Syllabus.pdf}{Linear Algebra}
\end{itemize}
:::
