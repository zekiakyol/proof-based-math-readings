...
- **MA** is the abrevviation of **Matrix Algebra - Karim M. Abadir, Jan R. Magnus (2005)**.
  
::: {.callout-tip icon=false}
## **Week 01-02 \hfill \faCalendar* 23 October - 05 November**

\begin{itemize}
  \item[\faBook] \textbf{MA}, Appendix A: Some mathematical tools
  \item[\faBook] \textbf{MA}, Appendix B: Notation
  \item[\faBook] \textbf{MA}, Chapter 1: Vectors
  \item[\faBook] \textbf{MA}, Chapter 2: Matrices
  \item[\faBook] \textbf{MA}, Chapter 4: Rank, inverse, and determinant
\end{itemize}
:::
...
\begin{itemize}
  \item[\faBook] \textbf{MA}, Chapter 5: Partitioned matrices
  \item[\faBook] \textbf{MA}, Chapter 6: Systems of equations
\end{itemize}
:::
...
\begin{itemize}
  \item[\faBook] \textbf{MA}, Chapter 7: Eigenvalues, eigenvectors, and factorizations
  \item[\faBook] \textbf{MA}, Chapter 8: Positive (semi)definite and idempotent matrices
\end{itemize}
:::
...
\begin{itemize}
  \item[\faBook] \textbf{MA}, Chapter 10: Kronecker product, vec-operator, and Moore-Penrose inverse
  \item[\faBook] \textbf{MA}, Chapter 11: Patterned matrices: commutation- and duplication matrix
\end{itemize}
:::
...
\begin{itemize}
  \item[\faBook] \textbf{MA}, Chapter 12: Matrix inequalities
  \item[\faBook] \textbf{MA}, Chapter 13: Matrix calculus
  \item[\faBook] \textbf{MA}, Chapter 3: Vector spaces (Optional)
\end{itemize}
:::
