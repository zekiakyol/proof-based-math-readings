...
\begin{itemize}
  ...
  \item[] We will also have a session on Basic Analysis I book. Please see our syllabus at \href{https://github.com/zekiakyol/proof-based-math-readings/blob/main/PBMR_RealAnalysis_Syllabus.pdf}{Real Analysis}
\end{itemize}
:::
